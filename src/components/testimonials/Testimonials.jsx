...
const data=[
  ...
  },
  {
    ...
    cert:'https://www.hackerrank.com/certificates/4651034b61d6'
  },
  {
    avatar:AVTR4,
...

  {
    ...
    review:'It covers topics like to create amazing site using HTML5,to work with Audio and Video in HTML5 ,Hands on experience on Data Input and Buttons,Hands on experience on Absolute and Relative Links and on Tags and Lists.' ,
  ...
  },
  {
    ...
    by:'Offered By :  Creative Online School',
    head: 'WHAT I HAVE LEARNT:',
    review:'It includes concepts like the event loop, promises, async/await, AJAX and APIs .OOP including ES5 prototypes & ES6 classes .ES6 features like arrow functions, classes, default and rest parameters, etc.',
...

{
  ...
  by:'Offered By :  Creative Online School',
  head: 'WHAT I HAVE LEARNT:',
  review:'Write scripts for general productivity tasks Read and comprehend Python code Gain knowledge in regard to general programming concepts. Use variables to store, retrieve and calculate information.' ,
